...
{name:"Relevé", macro_category:["All"]},
{name:"Attestation", macro_category:["All"]},
{name:"Contrat", macro_category:["All"]},
{name:"Quittance de loyer", macro_category:["Logement"]},
{name:"Facture", macro_category:["All"]},
{name:"Echéancier", macro_category:["All"]},
{name:"Avis d'imposition", macro_category:["Impôts"]},
{name:"Déclaration d'impôts", macro_category:["Impôts"]},
{name:"Garantie", macro_category:["All"]},
{name:"Fiche de paye", macro_category:["Emploi"]},
{name:"Diplôme", macro_category:["Etudes"]},
{name:"Ordonance", macro_category:["Santé", "Mutuelle", "Sécurité Sociale"]},
{name:"Inscription", macro_category:["All"]},
{name:"Abonnement", macro_category:["All"]},
{name:"Notification", macro_category:["All"]},
{name:"Avis de situation", macro_category:["All"]}
]
